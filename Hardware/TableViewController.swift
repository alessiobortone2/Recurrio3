...
class TableViewController: UIViewController, UITableViewController, UITextFieldDelegate, UITableViewDataSource, UITableViewDelegate,  BluetoothSerialDelegate {
